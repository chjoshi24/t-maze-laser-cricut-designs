# T-maze designs (Adobe Illustrator, SVG, and PDF files)
...
* The SVG files are created for making T-shaped cutouts using Cricut machines (Stroke width = 0.072 pt). It is a good idea to check what the appropriate stroke width is for your machine before proceeding. You can always edit the Adobe Illustrator file and save it as an SVG file.
